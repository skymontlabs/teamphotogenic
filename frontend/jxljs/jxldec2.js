var Module = function(n) {
    ...
    var T = [],
        ...
        C = "";
    C = 0 !== (C = self.location.href).indexOf("blob:") ? C.substr(0, C.lastIndexOf("/") + 1) : "", o = function(n) {
    ...
    ! function r() {
        ...
        function o(r, t) {
            var e, o = r.exports;
            n.asm = o, V((c = n.asm.x).buffer), w = n.asm.D, e = n.asm.y, q.unshift(e),
                function r(t) {
    ...
    var nR = n.___wasm_call_ctors = function() {
        ...
        nI = n.___embind_register_native_and_builtin_types = function() {
            return (nI = n.___embind_register_native_and_builtin_types = n.asm.C).apply(null, arguments)
        },
