  ...
  nav.innerHTML=`
      <div class="x y z nomax rel">
        <div id="La" class="noselect">
          ...
          <div id="Da" class="dropdown BlA lk">
        ...
        <div id="Ja" class="y z">
          ...
          <button id="Jf" type="button" data-testid="user-avatar" class="db">
            ...
            <div id="dfa" class="dropdown bsbx BlA">
              <div class="lk ">
                <i>Signed in as<br><b>StephenLiang@hpe.com</b></i>
              </div>
              <div class="lk nx">
                ...
                <span id="Sg" class="point"><span>Dark Mode</span> <div style="position: relative; top: 2px;"><span class="c-PJLV c-bQzyIt c-bQzyIt-ieQIGIs-css c-dJUkyX c-jRkEYY"><span><input type="checkbox" style="border: 0px; clip: rect(0px, 0px, 0px, 0px); height: 1px; width: 1px; margin: -1px; padding: 0px; overflow: hidden; position: absolute;"><span class="c-dtDgiN"><span class="c-dxUeQg c-dxUeQg-iHQPbX-checked-false"></span></span></span></span></div></span>
              </div>
              <div class="lk nx">
